...
Flow:
  ...
  2. Generate extraction prompt (news article only → AI)
  3. AI returns structured JSON of all individuals/entities in the article
  4. Apply Protocols 0–5 locally using fuzzy/semantic matching
  5. Output DISCOUNTED / ESCALATE per row
