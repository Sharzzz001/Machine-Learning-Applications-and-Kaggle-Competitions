...
"""
prompt = f"""You are a precise information-extraction assistant supporting a compliance n
Your task: read the news article below and extract every INDIVIDUAL and ENTITY (company / org
──────────────────────────────────────────────
...
"individuals": [
{{
"full_name": "aliases": "age": "<full name as written in article>",
["<any other names / nicknames used for this person in the article>"],
...
NAME_MATCH_THRESHOLD = 80 TRANSLITERATION_CHARS = 2 PROFILE_SIMILARITY_MIN = 45 NATIONALITY_SIM_MIN = 65 # fuzzy score to consider a name match
# max edit distance for transliteration leniency
# below this = profile mismatch flag
# below this = nationality mismatch flag
...
name_key = "entity_name" if subject_type.strip().lower() != "individual" else "full_n
...
# If the API returns a raw JSON string, parse it
